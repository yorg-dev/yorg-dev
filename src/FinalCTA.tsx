  ...
  return (
    <section className="final-cta-section relative px-6 py-28 text-center overflow-hidden">
      <div
        ...
        style={{
          background:
            'repeating-linear-gradient(90deg, #2a5018 0px, #2a5018 28px, #1e4010 28px, #1e4010 32px)',
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        >
          It's time to plant something better. Your first Agent is waiting. Your first harvest is
        ...
        >
          No tech skills required · First task completed in 10 minutes
        </p>
      </div>
    </section>
  )
