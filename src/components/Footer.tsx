...
const SOCIALS = [
  ...
  { label: 'Discord', href: 'https://discord.gg/kkckBV4A', Icon: DiscordIcon },
  { label: 'GitHub', href: 'https://github.com/yorg-dev', Icon: GitHubIcon },
...
const linkClass =
  'text-wood-600 hover:text-wood-300 transition-colors no-underline font-semibold text-sm leading-none'
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 mb-10">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="pixel-font text-wood-500 mb-3" style={{ fontSize: 7 }}>
              NEWSLETTER
            </p>
            <FooterNewsletter />
          </div>
          ...
          <div>
            <span className={colHeadingClass} style={{ fontSize: 7 }}>
              PRODUCT
            </span>
            ...
            <ul className="flex flex-col gap-3" style={{ fontFamily: 'Nunito, sans-serif' }}>
              {SOCIALS.map(({ label, href, Icon }) => (
                <li key={label}>
                  ...
                  >
                    <span className="text-wood-700 shrink-0">
                      <Icon />
                    </span>
                    {label}
                  </a>
