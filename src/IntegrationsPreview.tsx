...
const FEATURED = [
  {
    ...
    name: 'Slack',
    description:
      'Send alerts, summaries, and reports directly to your Slack channels — automatically.',
  },
  {
    icon: '🏆',
    name: 'HubSpot',
  ...
  },
  {
    ...
    name: 'Zapier',
    description:
      'Connect your Yorg agents to thousands of apps without writing a single line of code.',
  },
]
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'repeating-linear-gradient(90deg, #1e3a5a 0px, #1e3a5a 28px, #162e4a 28px, #162e4a 32px)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 65% 60% at 50% 50%, rgba(30,80,140,0.4) 0%, transparent 100%)',
        }}
      />
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-12">
          <div className="pixel-billboard px-10 py-4 mb-5">
            <span
              className="pixel-font text-wood-950"
          ...
          >
            Your agents plug right into the apps you already use. Your whole business runs together.
          </p>
        </div>
