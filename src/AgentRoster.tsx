const AGENTS = [
  {
    ...
    accent: '#f0a020',
    voice:
      "I find buyers before they've even heard of you. Plant me in your Sales Garden and I'll tend your pipeline while you're doing everything else.",
  ...
  },
  {
    ...
    accent: '#e87890',
    voice:
      'I fill your calendar with warm, qualified conversations — overnight. You wake up to meetings already booked.',
  ...
  },
  {
    ...
    accent: '#4aaa30',
    voice:
      "Leads don't go cold on my watch. I tend every prospect until they're ready to buy — or they tell me to stop.",
  ...
  },
  {
    ...
    accent: '#50b8e0',
    voice:
      "I keep you visible every single day without you tending a single post. Your audience grows while you're out doing the work you love.",
  ...
  },
  {
    ...
    accent: '#9060c0',
    voice:
      'I keep your list warm and engaged — on its own. One email chain can tend a relationship for months.',
  ...
  },
  {
    ...
    accent: '#e07820',
    voice:
      "Send polished, professional proposals in minutes — not the hours you're spending now. I handle the writing. You handle the close.",
...
export default function AgentRoster() {
  return (
    <section className="roster-section relative px-6 py-20" id="agents">
      <div
        className="benefits-top-border"
        style={{
          background:
            'repeating-linear-gradient(90deg, #4aafaa 0px, #4aafaa 28px, #3a9f9a 28px, #3a9f9a 32px)',
        }}
      />
            ...
            <div style={{ padding: '20px 18px 18px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
                ...
                <div>
                  <p
                    className="pixel-font"
                    style={{ fontSize: 8, color: '#3a2008', lineHeight: 1.8 }}
                  >
                    {agent.name}
                  </p>
                  <p
              ...
              <div style={{ borderTop: '2px dashed #c4924a', paddingTop: 10 }}>
                <p
                  className="pixel-font"
                  style={{ fontSize: 8, color: agent.accent, marginBottom: 4 }}
                >
                  BENEFIT
                </p>
                <p
